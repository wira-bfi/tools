...
test('Create a new survey 2w task', async ({ page }) => {
  ...
  const payload = {
    ...
    '$.customer.contact.mobile_number': '+6285200007213',
  ...
  await page.route(
    ...
    (route) => {
      route.fulfill({
        ...
        body: JSON.stringify({
          address: 'JL DN AGUNG SEL BLK 0-111 / 38 JAKUT',
          bpkb_number: 'No1887457',
          brand: 'VIAR',
          color: 'ABU - ABU',
          cylinder_capacity: null,
          fuel: 'LISTRIK',
          machine_number: 'VR001FMG17000001',
          manufacture_year: '2017',
          model: 'S.MTR/SCOOTER',
          name: 'PT TRIANGLE MOTORINDO',
          nik: null,
          registration_number: 'B 3203 UNP',
          registration_year: '2017',
          stnk_expiry_date: '25-04-2022',
          tax_expiry_date: '25-04-2018',
          type: 'SEPEDA MOTOR',
          vin: null,
        }),
      });
